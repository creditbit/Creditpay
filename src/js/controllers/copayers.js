  ...
  function($scope, $rootScope, $timeout, $log, $modal, profileService, go, notification, isCordova, gettext, gettextCatalog) {
    ...
    self.shareSecret = function(secret) {
      if (isCordova) {
        ...
        var message = 'Join my creditbit wallet. Here is the invitation code: ' + secret + '  You can download creditbit for your phone or desktop at https://www.creditbit.org';
        window.plugins.socialsharing.share(message, 'Invitation to share a creditbit Wallet', null, null);
      }
    };
